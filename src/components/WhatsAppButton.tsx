...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-[max(1.5rem,env(safe-area-inset-bottom))] right-6 z-50 w-16 h-16 rounded-full  will-change-transform bg-[#25D366] shadow-elegant flex items-center justify-center animate-pulse-glow"
    >
